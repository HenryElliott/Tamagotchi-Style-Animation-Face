...
def update_eye_positions_and_mouth():
...
def draw_eyes_and_mouth():
    ...
    mouth_center_x, mouth_center_y = update_eye_positions_and_mouth()
    draw_smiley_mouth(screen, MOUTH_COLOR, (mouth_center_x, mouth_center_y), 60, 30)
...
while running:
    update_eye_positions_and_mouth()
    draw_eyes_and_mouth()
    blink_animation()
    pygame.display.flip()
